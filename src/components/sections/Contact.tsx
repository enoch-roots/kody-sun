...
const GEO_FLOATS = [
  { left: "8%", delay: "0s", dur: "9s", size: 7, shape: "circle", op: 0.4 },
  {
    left: "18%",
    delay: "2.1s",
    dur: "11s",
  ...
  { left: "28%", delay: "0.7s", dur: "8s", size: 9, shape: "square", op: 0.25 },
  {
    left: "38%",
    delay: "3.4s",
    dur: "13s",
  ...
  { left: "88%", delay: "1.6s", dur: "11s", size: 7, shape: "circle", op: 0.3 },
  { left: "44%", delay: "5.2s", dur: "14s", size: 4, shape: "square", op: 0.2 },
  {
    left: "14%",
    delay: "6.0s",
    dur: "10s",
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden" ref={sectionRef}>
      {/* ── BACKGROUND ───────────────────────────────────────────── */}
      <div
      ...
      {/* ── CONTENT ──────────────────────────────────────────────── */}
      <div
        className="section relative z-20 flex flex-col items-center text-center"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <polygon
                points="40,-3   43,3   37,3"
                fill="none"
                stroke="rgba(218,234,255,.30)"
                strokeWidth=".5"
              />
              <polygon
                points="70.4,9.6  68.3,16.0  64.0,11.7"
                fill="none"
                stroke="rgba(218,234,255,.30)"
                strokeWidth=".5"
              />
              <polygon
                points="83,40   77,43   77,37"
                fill="none"
                stroke="rgba(218,234,255,.30)"
                strokeWidth=".5"
              />
              <polygon
                points="70.4,70.4  64.0,68.3  68.3,64.0"
                fill="none"
                stroke="rgba(218,234,255,.30)"
                strokeWidth=".5"
              />
              <polygon
                points="40,83   37,77   43,77"
                fill="none"
                stroke="rgba(218,234,255,.30)"
                strokeWidth=".5"
              />
              <polygon
                points="9.6,70.4  11.7,64.0  16.0,68.3"
                fill="none"
                stroke="rgba(218,234,255,.30)"
                strokeWidth=".5"
              />
              <polygon
                points="-3,40    3,37    3,43"
                fill="none"
                stroke="rgba(218,234,255,.30)"
                strokeWidth=".5"
              />
              <polygon
                points="9.6,9.6   16.0,11.7  11.7,16.0"
                fill="none"
                stroke="rgba(218,234,255,.30)"
                strokeWidth=".5"
              />
            ...
            >
              <circle
                ...
                cy="40"
                r="24"
                stroke="rgba(218,234,255,.2)"
                strokeWidth=".8"
              />
              <polygon
                points="40,16 64,40 40,64 16,40"
                stroke="rgba(218,234,255,.18)"
                strokeWidth=".7"
                fill="none"
              />
              <polygon
                points="23,23 57,23 57,57 23,57"
                stroke="rgba(218,234,255,.15)"
                strokeWidth=".7"
                fill="none"
              />
            </g>
            ...
            >
              ...
              />
              <path
                d="M40,40 Q46,36 40,32"
                stroke="rgba(218,234,255,.55)"
                strokeWidth=".85"
                fill="none"
                strokeLinecap="round"
              />
              <path
                d="M40,40 Q40.46,47.2 46.93,44"
                stroke="rgba(218,234,255,.55)"
                strokeWidth=".85"
                fill="none"
                strokeLinecap="round"
        ...
        <h2
          style={{
            ...
            marginBottom: "48px",
            background:
              "linear-gradient(315deg, #ffe896 0%, #ffd740 45%, #c4880c 100%)",
        ...
        {/* CTA Button */}
        <a
          href="mailto:kodysunbloom@gmail.com"
          style={{
            fontFamily: "var(--font-body)",
            fontSize: "11px",
            letterSpacing: ".45em",
