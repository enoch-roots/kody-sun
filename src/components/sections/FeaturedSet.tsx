...
const GEO_FALLS = [
  { left: "5%", delay: "0s", dur: "10s", size: 6, shape: "circle", op: 0.35 },
  {
    left: "15%",
    delay: "2.4s",
    dur: "12s",
  ...
  { left: "25%", delay: "1.0s", dur: "9s", size: 8, shape: "square", op: 0.22 },
  {
    left: "35%",
    delay: "3.8s",
    dur: "13s",
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: "linear-gradient(to bottom, transparent, #0a1224)",
        }}
      />
      ...
      <div className="section relative z-20">
        ...
        <div
          style={{
            height: "1px",
            background:
              "linear-gradient(90deg, rgba(196,136,12,.35), rgba(196,136,12,.08) 60%, transparent)",
            marginBottom: "36px",
          }}
        />
        ...
        >
          ...
          >
            ...
            >
              {[
                38, 62, 45, 80, 55, 90, 40, 75, 50, 88, 44, 70, 38, 95, 52, 78,
                42, 65, 48, 85, 36, 72, 58, 82, 46, 68, 54, 76, 40, 60,
              ].map((h, i) => (
                <div
                  key={i}
                  style={{
